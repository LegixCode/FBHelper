...
import Country from "@/pages/Actions/Modules/ModuleCountry.vue";
import Pixel from "@/pages/Actions/Modules/ModulePixel.vue";
import Card from "@/pages/Actions/Modules/ModuleCard.vue";
import Rules from "@/pages/Actions/Modules/ModuleRules.vue";
