...
export class BackgroundCurrencyConverter {
    private static instance: BackgroundCurrencyConverter | null = null;
    ...
    public static getInstance(): BackgroundCurrencyConverter {
        if (!BackgroundCurrencyConverter.instance) {
            BackgroundCurrencyConverter.instance = new BackgroundCurrencyConverter();
        }
        return BackgroundCurrencyConverter.instance;
    }
...
export function initBackgroundCurrencyConverter() {
    BackgroundCurrencyConverter.getInstance();
}
