            ...
            (this.getAllByKeyName = function (e, t) {
                ...
                return (
                    (this.recursive = function (e, t) {
                        for (var s in e)
                            "object" != typeof e[s] || this.isArray(e[s]) || null === e[s]
                                ? s === t && i.push(e[s])
                    ...
                    if (t > 0)
                        for (var i = 0; i < t; i++) {
                            ...
                            for (var n = 0; n < r; n++) {
                                ...
                                for (var o = 0; o < 9; o++) console.log(">> Generated value: " + this.randexp(s[n]));
                            }
                        }
                } else console.error("Regexps variable must be an array and dont be empty", e);
                return null;
            }),
            (this.generate = function (e) {
                this.isString(e) && (e = [e]), this.isArray(e) || (e = []), e.length <= 0 && (e = ["*"]);
